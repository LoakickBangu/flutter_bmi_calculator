...
class TransitionDot extends AnimatedWidget {
  ...
  Animation<int> get positionAnimation => IntTween(begin: 0, end: 50).animate(
      CurvedAnimation(parent: super.listenable, curve: Interval(0.15, 0.3)));
...
class LoopedSizeAnimation extends Animatable<double> {
  ...
  double transform(double t) {
    if (t < fullExpansionEdge) {
      ...
      return defaultSize +
          math.sin(numberOfCycles * 2 * math.pi * t) * expansionRange;
    } else {
